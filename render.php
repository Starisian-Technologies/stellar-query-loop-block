...
add_action('pre_get_posts', 'disable_publishpress_filters_if_active');

function stellar_user_post_query_render_callback($attributes, $content): bool|string {
...
register_block_type(__DIR__, [
    'render_callback' => 'stellar_user_post_query_render_callback'
]);
